...
def merge_sort(linked_list):
    """
    Funciton sorts a linked list in ascending order
...
def merge(left, right):
    """
    Merges two linkedlists, sorting by data in nodes
    ...
    while left_head or right_head:
        ...
        # Add the tail node from left to merged linked list
            ...
            # If data on left i less than right, set current to left node
